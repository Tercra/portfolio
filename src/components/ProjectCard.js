        ...
        <Box sx={{maxWidth:"800px", width:"80%", backgroundColor:twilight.lightTurquoise, margin:"25px auto", padding:"15px", borderRadius:"15px", display:"flex", flexFlow:"wrap"}}>
            ...
            <Box sx={{flexGrow:1, padding:"15px", minWidth:"350px", maxWidth:"50%"}}>
                ...
                <Box sx={{display:"flex", flexWrap:"wrap"}}>
                    <Chip size="small" label="Node.js" sx={{fontFamily:"monospace", color:twilight.dark, marginRight:"5px", marginBottom:"5px", backgroundColor:twilight.lightPeach}}/>
                    <Chip size="small" label="Express" sx={{fontFamily:"monospace", color:twilight.dark, marginRight:"5px", marginBottom:"5px", backgroundColor:twilight.lightPeach}}/>
                    <Chip size="small" label="MongoDB" sx={{fontFamily:"monospace", color:twilight.dark, marginRight:"5px", marginBottom:"5px", backgroundColor:twilight.lightPeach}}/>
                    <Chip size="small" label="React" sx={{fontFamily:"monospace", color:twilight.dark, marginRight:"5px", marginBottom:"5px", backgroundColor:twilight.lightPeach}}/>
                    <Chip size="small" label="Socket.io" sx={{fontFamily:"monospace", color:twilight.dark, marginRight:"5px", marginBottom:"5px", backgroundColor:twilight.lightPeach}}/>
